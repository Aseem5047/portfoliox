		...
		>
			<div className="flex w-full justify-between items-center max-w-7xl mx-auto">
				...
				>
					...
					<p className="text-white text-[18px] font-bold cursor-pointer flex justify-center align-center gap-1 ">
						Aseem <span className="text-[#03a9f4f0]">Gupta</span>
					</p>
				</Link>
					...
					{navLinks.map((link, i) => (
						<li
							className={`hover:text-white text-[18px] font-medium cursor-pointer ${
								active === link.title ? "text-[#03a9f4f0]" : "text-secondary"
							}`}
							key={link.id}
				...
				<div className="sm:hidden flex flex-1 justify-end items-center">
					...
					>
						<ul className="list-none flex flex-col items-start justify-end gap-6">
							{navLinks.map((link, i) => (
								<li
									className={`hover:text-white text-[16px] font-poppins font-medium cursor-pointer ${
										active === link.title
											? "text-[#03a9f4f0]"
											: "text-secondary"
									}`}
